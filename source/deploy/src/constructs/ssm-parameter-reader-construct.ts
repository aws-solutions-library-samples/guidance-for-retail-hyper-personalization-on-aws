...
export class SsmParameterReaderConstruct extends Construct {
    ...
    constructor(
        ...
        const parameterName = props.ssmParameterName.startsWith("/")
            ? props.ssmParameterName.slice(1)
        ...
        this.ssmParameter = new cdk.custom_resources.AwsCustomResource(
            ...
            "Param",
            {
                onUpdate: {
                    ...
                    physicalResourceId:
                        cdk.custom_resources.PhysicalResourceId.of(
                            physicalResourceId,
                        ),
                },
                ...
                policy: cdk.custom_resources.AwsCustomResourcePolicy.fromSdkCalls(
                    {
                        resources: [
                            `arn:aws:ssm:${props.ssmParameterRegion}:${stack.account}:parameter/${parameterName}`,
                        ],
                    },
                ),
            },
    ...
    public getJsonValue(): any {
        return cdk.Fn.toJsonString(
            this.ssmParameter.getResponseField("Parameter.Value"),
        );
    }
}
